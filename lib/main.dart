...
class imageResult extends Struct{
...
typedef convert_func = imageResult Function(Pointer<Uint8>, Pointer<Uint8>, Pointer<Uint8>, Int32, Int32, Int32, Int32);
typedef Convert = imageResult Function(Pointer<Uint8>, Pointer<Uint8>, Pointer<Uint8>, int, int, int, int);
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          ...
          if(Platform.isAndroid){
            ...
            imageResult imgP_ = conv(p, p1, p2, _savedImage.planes[1].bytesPerRow,
                _savedImage.planes[1].bytesPerPixel, _savedImage.planes[0].bytesPerRow, _savedImage.height);
            Pointer<Uint32> imgP = imgP_.image;
            int result = imgP_.result;
            print(">>>>>>>>>>>");
            print(result);
